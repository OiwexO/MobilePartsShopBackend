...
public class ManufacturerController {
    ...
    public ResponseEntity<List<ManufacturerResponse>> getAllManufacturers() {
        ...
        List<ManufacturerResponse> manufacturerResponses = ManufacturerMapper.toDtoList(manufacturers, httpServletRequest);
    ...
    public ResponseEntity<ManufacturerResponse> createManufacturer(@ModelAttribute ManufacturerRequest request) {
        ...
        try {
            ...
            final ManufacturerResponse manufacturerResponse = ManufacturerMapper.toDto(manufacturer, httpServletRequest);
